...
public class RecognitionMaskScoreView extends View implements ResultMaskView {
    ...
    public RecognitionMaskScoreView(final Context context, final AttributeSet set) {
        super(context, set);
